...
# Save workbook
saveWorkbook(wb, "E:/table/823_Simulation_IR_30000s_rep100.xlsx", overwrite = TRUE)


library(readxl)
hist_data <- read_excel("E:/table/823_Simulation_IR_30000s_rep1000.xlsx", sheet = "Z1_details")
hist(hist_data$IDI)
hist(hist_data$NRI_categ)
hist(hist_data$NRI_conti)
